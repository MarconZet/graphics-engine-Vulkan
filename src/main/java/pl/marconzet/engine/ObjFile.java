...
public class ObjFile {
    ...
    private void processVertex(String[] vertexData, List<Vector3f> verticesList, List<Vector3f> normalsList, List<Vector2f> texCoordsList, boolean smooth) {
    ...
    public Model toModel() {
        ...
        load(v, t, n, indices);
        return new Model(v, t, indices, size);
    }
